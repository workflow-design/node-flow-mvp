...
export async function POST(request: Request) {
  ...
  try {
    ...
    if (!body.imageUrl) {
      return NextResponse.json(
        { error: "imageUrl is required for reference-to-video" },
        { status: 400 }
      );
    }
    ...
    console.log("Veo 3.1 Ref API: calling fal-ai/veo3.1/reference-to-video");
    ...
    console.error("Veo 3.1 Ref API error:", error);
